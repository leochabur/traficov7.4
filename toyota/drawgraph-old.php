     ...
     if (isset($_POST['cargar'])){
       ...
       //    die($sql);
           ...
           while ($i){
                 ...
                 $data[$i[0]]=$i[1];
                 $auxid=$t_serv+'v';
                 $tablaEntrada.="<tr style='cursor: pointer;' class='show' bgcolor='$color' id=' $fecha $fecha $turno $serv".'ic'."$t_serv'>
          ...
          //  die($sql);
           ...
           while ($i){
                 ...
                 if (($j%2) == 0)
                    $color = '#D0D0D0';
                     ...
                     $color = '#FFFFFF';
                 $tablaSalida.="<tr class='show' style='cursor: pointer;' bgcolor='$color' id=' $fecha $fecha $turno $serv".'vc'."$t_serv'>
                                 <td align='center'>$fecha_prety</td>
                                 <td align='right'>$cant</td>
                                 <td align='right'>$valorconf</td>
                                </tr>";
           ...
           $chcnf = "";
           $chefc = "checked";
           $conn = mysql_connect("181.119.2.107", "mbexpuser", "Mb2013Exp");
           ...
           while ($i = mysql_fetch_array($result)){
                 ...
                 if (($j%2) == 0)
                    $color = '#D0D0D0';
                     ...
                     $color = '#FFFFFF';
                   // $data[$i[0]]=$i[1];
                 $tablaEntrada.="<tr class='show' style='cursor: pointer;' bgcolor='$color' id=' $i[4] $i[4] $turno $serv".'ie'."$t_serv'>
           ...
           while ($i = mysql_fetch_array($result)){
                 ...
                 if (($j%2) == 0)
                    $color = '#D0D0D0';
                     ...
                     $color = '#FFFFFF';
                    //$data2[$i[0]]=$i[1];
                    $tablaSalida.="<tr class='show' style='cursor: pointer;' bgcolor='$color' id=' $i[4] $i[4] $turno $serv".'ve'."$t_serv'>
                                 <td align='center'>$i[2]</td>
                                 <td align='right'>$i[3]</td>
                                 <td align='right'>$i[1]</td>
                             </tr>";
