     ...
     if (isset($_POST['cargar'])){
       ...
       //    die($sql);
           ...
           while ($i){
                 ...
                 $data[$i[0]]=$i[1];
                 $auxid=$t_serv+'v';
                 $tablaEntrada.="<tr style='cursor: pointer;' class='show' bgcolor='$color' id=' $fecha $fecha $turno $t_serv".'ic'."'>
           ...
           while ($i){
                 ...
                 if (($j%2) == 0)
                    $color = '#D0D0D0';
                     ...
                     $color = '#FFFFFF';
                 $tablaSalida.="<tr class='show' style='cursor: pointer;' bgcolor='$color' id=' $fecha $fecha $turno $t_serv".'vc'."'>
                                 <td align='center'>$fecha_prety</td>
                                 <td align='right'>$cant</td>
                                 <td align='right'>$valorconf</td>
                                </tr>";
