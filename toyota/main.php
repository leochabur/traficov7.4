  ...
  function encabezado($titulo){
           print '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
                  ...
                  <head>
                        ...
                        <link rel="stylesheet" type="text/css" href="../vista/css/jquery.notty.css" />
  ...
  function menu(){
      ...
      $menu = '<br><span class="ui-widget">Operacion Campana</span>
               ...
               <div id="menu">
                         <ul class="menu">
                             <li>
                                 <a href="/toyota/drawgraph.php" class="parent"><span>Informes</span></a>
                             </li>
                             <li>
                                 <a href="/toyota/viewsrv.php" class="parent"><span>Certificacion de Servicios</span></a>
                             </li>
                             <li>
                                 <a href="/toyota/layout.php" class="parent"><span>Layout</span></a>
                             </li>
                             <li>
                                 <a href="/toyota/viewanm.php" class="parent"><span>Anomalias</span></a>
                             </li>
                             <li>
