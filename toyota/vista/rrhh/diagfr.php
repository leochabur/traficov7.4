...
?>
   <link type="text/css" href="<?php echo RAIZ;?>/vista/css/jquery.ui.selectmenu.css" rel="stylesheet" />
    <link type="text/css" href="<?php echo RAIZ;?>/vista/css/chromas.css" rel="stylesheet"/>
...
<script type="text/javascript">
                          $(document).ready(function(){
                                                       ...
                                                       $('#periodo').mask("m9/2099");
                                                       $('#cargar').button().click(function(){
                                                                                              $.post("/modelo/rrhh/diagfr.php", {accion: 'sbana', periodo: $('#periodo').val(), emple: $('#empleador').val()}, function(data){
                                                                                                                                                                                                                                $('#sbana').html(data);
                                                                                                                                                                                                                             });
                                                                                              });
                                                       });
	...
	<div id="tabs-1" class="ui-state-highlight ui-corner-all">
         <form class="cmxform" id="commentForm">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Diagrama de Francos</legend>
                         <table border="0" align="center" name="tabla">
                                <tr>
                                    ...
                                    <td>
                                    Mes/A<?print htmlentities('ñ');?>o
                                    </td>
                                    <td><input id="periodo" name="periodo" size="8" class="ui-widget ui-widget-content  ui-corner-all" minlength="2"/></td>
                                    <td colspan="4" align="right"><input type="button" id="cargar" value="Cargar Diagrama"/> </td>
                                </tr>
                         </table>
                         <div id="sbana">
                         </div>
