  ...
  $conn = conexcion();
    ...
    /*    if ($servicio){
      ...
      /*  if ($servicio != 0)
        ...
        $sql.=" FROM (select id_estructura, id_micro, nombre, cantpax, id_servicio, id_estructura_servicio, hsalida, hllegada, hllegadaplantareal, hsalidaplantareal, fservicio, id from ordenes where (fservicio between '$desde' and '$hasta') and (not borrada) and (not suspendida) and (id_cliente = 10)) o
              left join obsSupervisores osu ON osu.id = o.id
