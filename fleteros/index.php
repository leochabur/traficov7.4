                          ...
                          <div>
                               <form id="login-form" name="login-form" method="POST" action="login.php">
                                     ...
                                     <fieldset>
                                               ...
                                               <div class="login-field above-below15"><h2>Acceso Fleteros</h2></div>
                                               <div class="login-field above-below15 above30 clear">
                                                    <label for="username" class="placeholder ">Usuario</label>
                                                    <input type="text" name="txtNombre" tabindex="2" class="required av-text" value="" id="username">
                                               </div>
                                               <div class="login-field above-below15">
                                                    <label for="password" class="placeholder ">Password</label>
                                                    <input type="password" name="txtPassword" tabindex="3" class="required av-password" value="" id="password">
                                               </div>
