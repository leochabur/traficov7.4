                     ...
                     <?php
                          if (isset($_GET['e'])){
                             if ($_GET['e'] == '0') //usuario o password invalido
                                $mje = 'Usuario o contrase'.utf8_encode('ñ').'a invalidos!';
...
?>
                          <div>
                               <form id="login-form" name="login-form" method="POST" action="login.php">
                                     ...
                                     <div class="login-field above-below15">Acceso Exteno</div>
                                     <fieldset>
                                               <legend>Secure Login</legend>
                                               <div class="login-field above-below15 above30 clear">
                                                    <label for="username" class=" ">CUIT Empleador</label>
                                                    <input type="text" name="cuit" tabindex="1" class="cuit required av-text" value="" id="cuit">
                                               </div>
                                               <div class="login-field above-below15 above30 clear">
                                                    <label for="username" class=" ">Legajo</label>
