<?php session_start();
  ...
  function getNovTraf(){
           ...
           if (mysql_num_rows($result) > 0){
              $trafico = '$.notty({
                                   ...
                                   content : "<a href=\'vwnsiso.php\'><font color=\'#FF0000\'>Documentacion SGI Disponible</font></a>';
  ...
  function menu(){
      $anomalias = "";
      if ($_SESSION['id_empleador'] == 51)
      {
        $anomalias ='<li><a href="anomalias.php"><span>Anomalias</span></a></li>';
      }
      $menu = '<br><span class="ui-widget"><b>'.htmlentities($_SESSION['chofer']).' - '.htmlentities($_SESSION['empleador']).'</b></span>
               ...
               <div id="menu">
                         <ul class="menu">
                             ...
                             <li>
                              ...
                              <li>
                                 <a href="dgmwrk.php" class="parent"><span>Ver Diagrama</span></a>
                             </li>'.
                             $anomalias.'             
                             <li>
                             <a href="avirtual.php"><span>Aula Virtual</span></a>
                             </li>                    
                             <li>
                                 <a href="#"><span>Cambiar Contrase&ntilde;a</span></a>
                             </li>
                             <li>
                                 <a href="/externos/logout.php" class="parent"><span>Salir</span></a>
                             </li>
                         </ul>
               </div>';
        print $menu;
