...
function Header()
{
    ...
    $this->Cell(80);
    // Título
    $this->Cell(45,10,"Infome de Eficiencia - Mes: $_GET[mes] - Año: $_GET[anio]",0,0,'C');
    // Salto de línea
    $this->Ln(20);
}
...
//die($sql);
            ...
            $pdf->Cell(28,7,'Eficiencia (%)',1, 0, 'C', True);
                    $pdf->Ln();
            ...
            while ($data){
                  ...
                  while ($data && ($tipo == $data[0])){
                        ...
                        if ($last_tipo != 'Produccion'){
                           $pdf->Cell(253,6,"TOTAL EFICIENCIA $last_tipo: $prom",1, 0, 'C', True);
                           $pdf->Ln();
                        }
                        else{
                             $pdf->Cell(253,6,"TOTAL EFICIENCIA $last_tipo TURNO $last_turno: $prom",1, 0, 'C', True);
                           $pdf->Ln();
                        }
                  }
            }
