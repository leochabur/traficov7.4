                          ...
                          $(document).ready(function(){
                                                       ...
                                                       $('#newepe').validate({
                                                                              submitHandler: function(e){
                                                                                                                 ...
                                                                                                                 $.post("/modelo/bd/tablas/classup.php", datos, function(data){
                                                                                                                                                                               if (data != 1)
                                                                                                                                                                                  alert(data);
                                                                                                                                                                             $('#mensaje').html(data);
                                                                                                                                                                             });
	...
	<div id="tabs-1" class="ui-state-highlight ui-corner-all">
         <form id="newepe">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Alta de Clase de Servicio</legend>
		                 <div id="mensaje"></div>
                         <table border="0" align="center" width="50%" name="tabla">
                                <tr>
                                    <td WIDTH="20%">Nombre Clase</td>
                                    <td><input id="type" name="type" class="required ui-widget ui-widget-content  ui-corner-all" minlength="2"/></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td colspan="3" align="right"><input type="submit" id="save" value="Guardar Clase"/> </td>
                                </tr>
                         </table>
            </fieldset>
