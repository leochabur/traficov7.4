...
$pdf->SetFont('Times','',10);
       ...
       if (i_v is null, if(o.id_ciudad_destino = 3, o.hllegada, null), if (i_v = 'i', o.hllegada, null)) as Hora_Diagramada_Llegada_Planta,
       if (i_v is null, if(o.id_ciudad_destino = 3, o.hllegadaplantareal, null), if (i_v = 'i', o.hllegadaplantareal, null)) as Hora_Real_Llegada_Planta,
       if (i_v is null, if(o.id_ciudad_destino = 3, null, o.hsalida), if (i_v = 'i', null, o.hsalida)) as Hora_Diagramada_Salida_Planta,
       if (i_v is null, if(o.id_ciudad_destino = 3, null, o.hsalidaplantareal), if (i_v = 'i', null, o.hsalidaplantareal)) as Hora_Real_Salida_Planta,
