...
<script type="text/javascript">
                          $(document).ready(function(){
                                                       ...
                                                       $("#cargar").button().click(function(){
                                                                                              ...
                                                                                              $.post("/modelo/informes/cria/kmrecliun.php", {accion:'reskm', str:$('#str').val(), desde: $('#desde').val(), hasta: $('#hasta').val(), internos:$('#internos').val()}, function(data){  $('#dats').html(data);
                                                                                                                                                                           });
                                                       });
                                                       $('#str').selectmenu({width: 350});
                                                       $('#str').change(function(){
                                                                                  $.post("/modelo/informes/cria/kmrecliun.php",{accion:'ldint', str:$('#str').val()}, function(data){
                                                                                                                                                                                   $('#clis').html(data);
                                                                                                                                                                                   });
                                                                                  });
    ...
    <br><br>
         <form id="upuda">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Resumen Km por Interno</legend>
		                 <div id="mensaje"> </div>
		                 <fieldset class="ui-widget ui-widget-content ui-corner-all">
