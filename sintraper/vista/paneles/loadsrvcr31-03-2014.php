<?php
     ...
     if ($accion == 'lcr'){
        ...
        $sql="SELECT km, DATE_FORMAT(tiempo_viaje, '%H:%i') as tiempo, o.ciudad as origen, d.ciudad as destino, cs.clase, c.activo, c.id
              FROM cronogramas c
        ...
        $select = "<table border='0' align='center' width='75%'>
                   <tr>
                       ...
                       <td><input type='text' size='20' class='ui-widget-content ui-corner-all' value='".htmlentities($data['origen'])."'></td>
                       <td></td>
                   </tr>
                   <tr>
                       <td WIDTH='20%'>Destino</td>
                       <td><input type='text' size='20' class='ui-widget-content ui-corner-all' value='".htmlentities($data['destino'])."'></td>
                       <td></td>
                   </tr>
                   <tr>
                   ...
                   <td WIDTH='20%'>Clase</td>
                       <td><div id='clase-$data[id]' class='updclase'>$data[clase]</div></td>
                       <td></td>
                   </tr>
                   <tr>
