...
<script type="text/javascript">
                          $(document).ready(function(){
                                                       ...
                                                       $('#cargar').button().click(function(){
                                                                                              $.post("/modelo/rrhh/diagfrtr.php", {accion: 'sbana', desde: $('#desde').val(), hasta: $('#hasta').val(), emple: $('#empleador').val()}, function(data){
	...
	<div id="tabs-1" class="ui-state-highlight ui-corner-all">
         <form class="cmxform" id="commentForm">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Diagrama de Francos Trabajados</legend>
