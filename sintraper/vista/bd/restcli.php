...
<script type="text/javascript">
                          $(document).ready(function(){
                                                       ...
                                                       $.post("/modelo/bd/restcli.php", {accion: 'load'}, function(data){$('#data').html(data);});
    ...
    <br><br>
         <form id="upuda">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Condifurar Restricciones Clientes</legend>
		                 <div id="mensaje"> </div>
                         <div id="data"></div>
                         <br>
                         <div id="data"> </div>
