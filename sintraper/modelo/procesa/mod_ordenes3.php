...
elseif ($accion == 'dupl'){
     ...
     if ($row = mysql_fetch_array($result)){
        ...
        $values = "     $row[1],    '$row[2]', '$row[3]', '$row[4]', '$row[5]','$row[6]',   '$row[6]',      $row[8], $row[9],      $row[10],                $row[11],           $row[12],                    $row[13],           $row[14],                   $row[15],      $row[16],              $clivac,          $eclivac,              0,          0,      ''         ,$row[22],    $_SESSION[userid], now(),       0,      0,0";
