     ...
     if ($accion == 'lcr'){
        ...
        while ($data = mysql_fetch_array($result)){
              ...
              $tabla.="<tr id='$data[id_crono]'>
                              ...
                              <td><input type='button' id='boton$data[id_crono]' value='$label' onClick='modCron(this.value, $data[id_crono]);'></td>
                       </tr>";
        }
                  ...
                  <script>
                                ...
                                function modCron(label, cronog){
                                    ...
                                    if (label == "Desac."){
                                     ...
                                     $.post("../../modelo/servicios/addsrvcron.php", {sta:st, cron:cronog, accion:"acdecro"},function(data){
                                                                                                                                         $("#boton"+cronog).attr("value",val);
                                                                                                                                         });
                           }
                  </script>';
        print $tabla;
     ...
     elseif ($accion == 'lsrv'){
            ...
            while ($data = mysql_fetch_array($result)){
              ...
              $tabla.="<tr id='$data[id]'>
                              ...
                              <td><input type='button' id='servi$data[id]' value='$label' onClick='modSrv(this.value, $data[id]);'></td>
                       </tr>";
            }
            mysql_free_result($result);
            mysql_close($conn);
                  ...
                  <script>
                                ...
                                function modSrv(label, servi){
                                    ...
                                    if (label == "Desac."){
                                     ...
                                     $.post("../../modelo/servicios/addsrvcron.php", {sta:st, srv:servi, accion:"acdesrv"},function(data){
                                                                                                                                         $("#servi"+servi).attr("value",val);
                                                                                                                                         });
                           }
                  </script>';
            print $tabla;
