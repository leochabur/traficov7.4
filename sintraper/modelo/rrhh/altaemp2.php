<?
  ...
  $values= "$_SESSION[userid],$_POST[legajo], '$_POST[dire]', $city, '$_POST[tele]', '$naci', '$_POST[sexo]', '$fnac', '$_POST[tipodoc]', '$_POST[nrodoc]', '$_POST[cuit]', 1, null, $_POST[puesto], $_POST[empleador], '$fini', '$_POST[ape]', '$_POST[nom]', now(), $estructura, $estructura, $procesado, $estructura, $estructura, $estructura, 0";
