...
$emp="";
          ...
          $sql="SELECT upper(c.descripcion) as cargo, e.id_empleado, legajo, upper(concat(apellido, ', ',e.nombre)) as apenom, nrodoc, upper(razon_social) as empleador, if(e.activo, 'checked', '') as activo, es.nombre as str
                FROM empleados e
