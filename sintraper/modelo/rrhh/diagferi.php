...
table thead tr .header {
	...
	cursor: pointer;
                        ...
                        <script type='text/javascript'>
                                ...
                                function cambiarFranco(emp, fec, st){
                                         ...
                                         $.post('/modelo/rrhh/diagferi.php', {accion:'update', id_e: emp, fecha: fec, estado: state});
                                }";
              $tabla.="</script>";
  ...
  elseif($accion == 'update'){
     ...
     if ($st){
        ...
        $values = "$conductor, '$fecha', '$fecha', 17, 'no_disp', 1, 0, $_SESSION[userid], now(), '', $_SESSION[structure]";
