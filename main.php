<?php 
  ...
  function encabezado($titulo, $load = false){
    die("sdasfasfafaf        ".$load);
            $script = '<script type="text/javascript" src="'.RAIZ.'/vista/js/jquery-1.7.2.min.js"></script>';
            if ($load){
              $script = '<script type="text/javascript" src="'.RAIZ.'/vista/js/MDB-Free_4/js/jquery-3.4.1.min.js">';
            }
  ...
  function menu(){
      ...
      $menu = '<br><span class="">'.$_SESSION['structure_name'].'</span>
