<?php
  ...
  include ('./controlador/bdadmin.php');
        ...
        from (select * from ordenes where fservicio = date(now()) and not suspendida and not borrada and id_servicio is not null and hsalidaplantareal < hcitacionreal) ord
        ...
        $urlProd = "https://admtickets.masterbus.net/api/integrations/traffic/trips";
        $urlStage = "http://paxtracker.mspivak.com/api/integrations/traffic/trips";
