...
<script type="text/javascript" src="<?php echo RAIZ;?>/vista/js/validate-form/jquery.metadata.js"></script>
 <script>
	$(function() {
        ...
        $('#srg').click(function() {
                                   if($(this).is(':checked')) {
                                                              $( "#fregreso, #hsalidaregreso, #hllegadaregreso" ).removeClass( "required" );
                                   }
                                   else {
                                        $( "#fregreso, #hsalidaregreso, #hllegadaregreso" ).addClass( "required" );
                                   }
        });
        ...
        $('#commentForm').validate({
                                  submitHandler: function(){
                                                            ...
                                                            $.post("/modelo/turismo/procesar_ordenes.php", datos, function(data) {
                                                                                                                                 ...
                                                                                                                                 alert(response.msge);
                                                                                                                                  if (response.status){
                                                                                                                                     if (!confirm('Continuar cargando ordenes iguales?')){
                                                                                                                                        $('#commentForm')[0].reset();
                                                                                                                                     }
                                                                                                                                  }
                                                                                                                                  else{
                         ...
                         <table border="0" align="center" width="75%">
                                ...
                                <tr>
                                    ...
                                    <td><select id="destino" name="destino" title="Please select something!"  class="chng ui-widget-content  ui-corner-all"  validate="required:true">
                                        ...
                                        Lugar Llegada<input id="lugarllegada" name="lugarllegada" class="<?php echo $required;?>ui-widget-content ui-corner-all" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><input id="nombre" name="nombre" class="<?php echo $required;?> ui-widget-content  ui-corner-all" minlength="2" size="75" <?php echo "$readonly";?>/></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td WIDTH="20%">Km del Servicio</td>
                                    <td colspan="2"><input id="km" size="4" name="km" class="<?php echo $required;?> ui-widget-content  ui-corner-all" <?php echo "$readonly";?>/></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input id="fsalida" name="fsalida" class="<?php echo $required;?> ui-widget-content  ui-corner-all" minlength="2" <?php echo "$readonly";?>/></td>
                                    <td></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td WIDTH="20%"><label for="fservicio">Sin Regreso</label></td>
                                    <td><input id="srg" name='srg' type="checkbox" class="ui-widget ui-widget-content  ui-corner-all"></td>
                                    <td></td>
                                </tr>
                                <tr>
