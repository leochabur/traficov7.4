...
<!-----#barramenu---->
	<!----- header---->
	<div id="barramenu" class="navbar  navbar-fixed-top headroom" >
		<div class="container">
			<div class="logo">
				<a href="<?php echo URL_INICIO;?>">
					<img src="<?php echo URL_WEB;?>imgs/logos/logo_sinfondo_168x60.png" class="" alt="<?php echo WEB_TITULO;?>" title="<?php echo WEB_TITULO;?>" >
				</a>
			</div>
			<!----start-top-nav---->
			 <nav class="top-nav">
				...
				<a href="#" id="pull"><img src="<?php echo URL_WEB;?>imgs/iconos/nav-icon.png" title="Men&uacute;" /></a>
			</nav>
