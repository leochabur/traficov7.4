...
table thead tr .header {
  ...
  elseif($accion == 'update'){
     ...
     if ($st)
     {
        ...
        $values = "$conductor, '$fecha', '$fecha', 17, 'no_disp', 1, 0, $_SESSION[userid], '$fechaAlta', '', $_SESSION[structure]";
        try
        {
          ...
          $conn = conexcion();
          $sql = "DELETE FROM novedades where (desde = '$fecha') and (id_empleado = $conductor) and (id_novedad = 17) and (id_estructura = $_SESSION[structure])";
