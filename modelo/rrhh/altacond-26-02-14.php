<?
  ...
  elseif($accion == 'upcond'){
          ...
          $campos = "afectado_a_estructura, id_estructura, id_empleador, id_estructura_empleador, apellido, nombre, nrodoc, domicilio, telefono, id_ciudad, id_estructura_ciudad, fechanac, inicio_relacion_laboral, cuil, activo $userdef";
          $values = "$_POST[struct], $_POST[struct], $_POST[empleador], $_SESSION[structure], '$_POST[apellido]', '$_POST[nombre]', '$_POST[dni]', '$_POST[direccion]', '$_POST[telefono]', $_POST[city], $_SESSION[structure], '$fnac', '$firl', '$_POST[cuil]', $activo $userid";
