<?
                ...
                <form id="modunidad">
                         <table border="0" align="center" width="50%" name="tabla">
                                ...
                                <tr>
                                    ...
                                    <td><input id="tel" name="tel" readonly value="'.$data['telefono'].'" class="required ui-widget ui-widget-content  ui-corner-all" minlength="2"/></td>
                                    <td></td>
                                </tr>
                                <tr>
  ...
  elseif($accion == 'upnove'){
                 ...
                 $sql = "select id as id_orden from ordenes where (not finalizada) and (fservicio between '$desde' and '$hasta') and (id_chofer_1 = $cond) and (id_estructura = $_SESSION[structure])";
                 $result = mysql_query($sql, $conn);
                 cerrarconexcion($conn);
                 ...
                 $conn = conexcion();
                 $sql = "select id as id_orden from ordenes where (not finalizada) and (fservicio between '$desde' and '$hasta') and (id_chofer_2 = $cond) and (id_estructura = $_SESSION[structure])";
                 $result = mysql_query($sql, $conn);
                 cerrarconexcion($conn);
