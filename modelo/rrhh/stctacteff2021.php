<?php
  ...
  if($accion == 'load')
  {
      ...
      $inicio = DateTime::createFromFormat('Y-m-d', "$_POST[anio_d]-$_POST[mes_d]-26");      
     ...
     /* $fin = clone $inicio;
      ...
      try
      {
          ...
          $q->setParameter('hasta',  $fin->format('Y-m-d'));
       ...
       $select.="</select>";
          ...
          $tabla ='<table id="tablitasssss" align="center" width="100%" class="table table-zebra">
                     <thead>
                            ...
                            <tr>
                                ...
                                <th align="center">Franco A Compensar</th>
                                <th align="center">Francos</th>
          ...
          $mesActual = ($_POST['mes_d'] -2);
          $mesAdelante = ($_POST['mes_h']-1); //en jquery es el mes menos uno
          $tabla.="</tbody>
                   </table>
                   <div id='detalle'>
                   </div>
                   <script type='text/javascript'>
                      ...
                      $('.fechaadelante').datepicker({
                        minDate: new Date($_POST[anio_d],$mesActual, 26), maxDate: new Date($_POST[anio_h],$mesAdelante, 25)
                        });
