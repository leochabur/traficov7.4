                                      ...
                                      if ($tfa){ ///existe una tarifa para el tipo de vehiculo
                                          if ($tfa->getArticulo()!= null){
                                            if (isset($factura[$tfa->getArticulo()->getId()]))
                                              ...
                                              $factura[$tfa->getArticulo()->getId()] = array('art'=> $tfa, 'cant' => $value['cant'], 'tfa'=>$tfa, 'ords' => array());
                                            }
                                            ...
                                            if (isset($factura[$tarifa->getNombre()]))
                                              ...
                                              $factura[$tarifa->getNombre()] = array('art'=> $tarifa->getNombre(), 'cant' => $value['cant'], 'tfa'=>$tfa);
                                            }                                          
