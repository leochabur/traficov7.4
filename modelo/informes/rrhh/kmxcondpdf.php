    ...
    $sql="SELECT o.*,
          ...
          FROM(
                (SELECT interno, upper(c.razon_social)as razon_social, 0 as id_cond, fservicio as fsrv, upper(servicio) as servicio, date_format(hsalida, '%H:%i') as hsalida, 
                       ...
                       hllegadaplantareal, hsalidaplantareal, hfinservicioreal, hcitacionreal, vacio
              ...
              //   while (($data) && ($cond == $data['legajo'])){
                    ...
                    for ($i=0; $i <= $data['dias']; $i++){
                     ...
                     /*  if ($data['legajo'] == 0){
                       ...
                       $pdf->Cell(10,7,"$data[citaReal]",0,0,'C');
                       $pdf->Cell(10,7,"$data[saleReal]",0,0,'C');
                       $pdf->Cell(10,7,"$data[finaReal]",0,0,'C');
                       $auxY = $pdf->GetY();
                       $auxX = $pdf->GetX();
