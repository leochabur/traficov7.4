<?
  ...
  elseif($accion == 'reskm'){
     ...
     $sql = "select upper(razon_social) as cli, date_format(o.fservicio, '%d/%m/%Y') as fservicio, interno, upper(ori.ciudad), upper(des.ciudad), o.km, comentario , upper(concat(e1.apellido,', ', e1.nombre)) as emple1, id_chofer_1, o.hcitacion, o.hsalida, o.hfinservicio, cita, fina, o.nombre as nomsrv
             from (select nombre, id_ciudad_origen, id_estructura_ciudad_origen, id_ciudad_destino, id_estructura_ciudad_destino, id_micro, id_estructura_cliente, comentario, km, o.id, id_chofer_1, o.hcitacion, o.hsalida, o.hfinservicio, o.hllegada, id_cliente, fservicio, TIME_TO_SEC(o.hcitacion) as cita, TIME_TO_SEC(o.hfinservicio) as fina
                   from ordenes o
                   ...
                   union all
                   select nombre, id_ciudad_origen, id_estructura_ciudad_origen, id_ciudad_destino, id_estructura_ciudad_destino, id_micro, id_estructura_cliente, comentario, km, o.id, id_chofer_2, o.hcitacion, o.hsalida, o.hfinservicio, o.hllegada, id_cliente, fservicio, TIME_TO_SEC(o.hcitacion) as cita, TIME_TO_SEC(o.hfinservicio) as fina
                   from ordenes o
