             ...
             if (false){
              ...
              /*   $sql="SELECT id_novedad
                 ...
                 if (!($reiniciar)){
                             ...
                             if (($desde > $corte50)){
                                $min_aux = datetomin($ultima_vuelta->diff($desde));
                                if($min_aux >= 720){
                                                                           //die("porque por aca ".$ultima_vuelta->format('Y-m-d H:i:s'));
                                }
                                else{
                        ...
                        $total_min_50+=redondearMinutos($minutos_al_50);
                        $minutos_al_50=0;
                        $total_min_100+=redondearMinutos($minutos_al_100)+redondearMinutos(720-$min_aux);
                        $minutos_al_100=0;
                        $corte=0;
                        $ultima_vuelta=0;
                                    // die("es menor es menor ".$desde->format('Y-m-d H:i:s')." ".$ultima_vuelta->format('Y-m-d H:i:s')." ".datetomin($ultima_vuelta->diff($desde)));
                                }
                             }
                     if ($desde >=$corte100){
                        ...
                        $ultima_vuelta=0;
                             ...
                             $ultima_vuelta=0;
                              ...
                              if ($ultima_vuelta){
                               if(datetomin($ultima_vuelta->diff($desde)) >= 720){
                                 ...
                                 //   die("$data[dtdesde] deberia haber entrado aca");
                               }
                               }
                         ...
                         /*      else{
                               ...
                               //     $total_min_50+=redondearMinutos($minutos_al_50);
                               //     $minutos_al_50=0;
                                    $total_min_100+=redondearMinutos(datetomin($ultima_vuelta->diff($desde)));
                                    $minutos_al_100=0;
                                    $corte=0;
                                    $ultima_vuelta=0;
                               }   */
