...
try{
     ...
     $ids.="0";
      ...
      $sql="select fservicio, c.nombre, 1 as cant, if(c.id is null, null, c.id) as crono, dayofweek(fservicio) as dia, if(s.id_TipoServicio = 20, 0, tu.id) as tipo, o.id as orden, 
