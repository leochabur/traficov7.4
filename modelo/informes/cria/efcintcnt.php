...
where fservicio between '$desde' and '$hasta' and o.id_estructura = $_SESSION[structure] and (u.id_propietario = $_POST[emp] or e.id_empleador = $_POST[emp]) and not borrada and not suspendida) o
