                ...
                // die(var_dump($coches));/*
                 ...
                 foreach($coches as $coche){
                    ...
                    $tabla.="<tr class='$class'>
                                  ...
                                  <td class='$class' align='center'><a href='#' class='addcga' data-id='".$coche['id']."'><i class='fas fa-gas-pump fa-2x'></i></a></td>
  ...
  elseif($accion == 'setTque'){
                 ...
                 foreach($coches as $coche){
                    $tabla.="<tr>
									...
									<td><input type='text' id='con-".$coche->getId()."' size='4' value='".$coche->getConsumo()."' class='ui-widget ui-widget-content  ui-corner-all'></td>
									<td><input type='button' value='Guardar' class='tque' data-id='".$coche->getId()."'></td>
                             </tr> ";
				 }
				 $tabla.="</tbody>
						  </table>
