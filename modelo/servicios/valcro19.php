...
elseif($accion =='addart'){
    try{
      ...
      if (!$cli){
              print json_encode(array('ok' => false, 'price'=>"$price", 'message'=>'No encuentra al cliente'));
              exit();
      }
      ...
      print json_encode(array('ok' => false, 'price'=>"$price", 'message'=>'Se han producido errores al realizar la accion!! '.$e->getMessage()));
  } 
}
