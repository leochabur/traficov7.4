...
if ($accion == 'cpy')
{
  ...
  try
  {
     ...
     $sql = "SELECT o.nombre as nombre, o.hcitacion, o.hsalida, o.hllegada, o.hfinservicio as hfinservicio, c.km, o.id_micro, o.id_servicio, o.id_estructura_servicio,
     ...
     {
        $keySrv = $data['idServ'];
        if (!array_key_exists($keySrv, $ordenesAuto)) //el servicios no se encuentra diagramado como automatico
        {
         ...
         else
         {
            if (!$data['borrada'])
            {
               ...
               update('ordenes', $campos, $values, "(id = $ordenesAuto[$keySrv]) and (id_estructura = $_SESSION[structure])", $conn);
            }
         }
     }
