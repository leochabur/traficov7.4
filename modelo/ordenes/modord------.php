...
/*try{
 ...
 /* foreach ($orden->getOrdenesVacios() as $value) {
  ...
  if ($diagramaFinalizado){
    $camposHorario = "hcitacion, hsalida, hllegada, hfinservicio, hcitacionreal, hsalidaplantareal, hllegadaplantareal,hfinservicioreal ";
    $valuesHorario = "'$hcitacionDiag', '$hsalidaDiag', '$hllegadaDiag', '$hfinservDiag', '$hcitacion', '$hsalida', '$hllegada', '$hfinserv'";
  }
  else{
