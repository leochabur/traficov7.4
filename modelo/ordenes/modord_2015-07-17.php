<?
  ...
  $campos = "id_user, fecha_accion, fservicio, nombre, hcitacion, hsalida, hfinservicio, km, id_chofer_1, id_chofer_2, id_micro, id_cliente_vacio, finalizada, borrada";
  $values = "$_SESSION[userid], now(), '$fecha', '".$nombre."', '$hcitacion', '$hsalida', '$hfinserv', $km, $chofer1, $chofer2, $interno, $clivacio, $final, $borra";
