<?php
  ...
  if ($accion == 'sve'){ ///codigo para guardar ////
        ...
        $sql = "SELECT id, hcitacion, hsalida, hllegada, hfinservicio FROM ordenes HWERE fservicio = '$fecha'";
        $result = mysql_query($sql, $conn);
        while ($data = mysql_fetch_array($result)){
              "INSERT INTO horarios_ordenes (id_orden, hcitacion, hsalida, hllegada, hfinalizacion, id_tipo_servicio, id_turno) VALUES ()";
        }
