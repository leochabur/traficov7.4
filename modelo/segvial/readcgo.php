...
order by nro_descargo";
 //    die($sql);
     ...
     $tabla=$pendi.'<a href="/modelo/rrhh/export-pe.php?desde='.$desde.'&hasta='.$hasta.'&cond='.$_POST['conductores'].'&res='.$_POST['reso'].'&ent='.$_POST['entr'].'"><img title="Exportar a Excel" src="../../vista/excel.jpg" width="35" height="35" border="0"></a>
     ...
     while ($data = mysql_fetch_array($result)){
               ...
               $tabla.="<tr id='$data[7]' $class>
                            ...
                            <td align='left'>$data[6]</td>
                             <td align='center'><a href='../../vista/segvial/updcgo.php?nro=$data[id]&ds=$_POST[desde]&hs=$_POST[hasta]&cnd=$_POST[conductores]'><img src='../../vista/edit.png' border='0' width='15' height='15'></a></td>
