<?
  ...
  if ($accion == 'sve'){ ///codigo para guardar ////
     ...
     $values.=",". ($_POST[ortra] ? $_POST[ortra]:"NULL");
     $values.=",". ($_POST[estr] ? $_POST[estr]:"NULL");
     $values.=",". ($_POST[heridos] ? "'".cambiarStr($_POST[heridos])."'":"NULL");
     $values.=",". ($_POST[organismo] ? $_POST[organismo]:"NULL");
     $values.=",". ($_POST[desc_hecho] ? "'".cambiarStr($_POST['desc_hecho'])."'":"NULL");
     $values.=",$_SESSION[userid]";
     $values.=",NOW()";
     $values.=",".($_POST[estr] ? $_POST[estr]:"NULL");
     $values.=",".($_POST[ubicahecho] ? "'".cambiarStr($_POST['ubicahecho'])."'":"NULL");
     ...
     try{
         insert("hechos_vandalicos", $campos, $values);
         $response[msge] = "El hecho ha sido dado de alta con exito en la BD!";
  ...
  elseif($accion == 'update'){
     ...
     $values.=",NOW()";
     $values.=",".($_POST[estr] ? $_POST[estr]:"NULL");
     $values.=",".($_POST[ubicahecho] ? "'".str_replace(",",";",$_POST[ubicahecho])."'":"NULL");
     $values.=",".($_POST[lat] ? $_POST[lat]:"NULL");
     $values.=",".($_POST[long] ? $_POST[long]:"NULL");
     ...
     try{
         begin($conn);
         backup('hechos_vandalicos', 'hechos_vandalicos_modificados', $cond, $conn);
         update('hechos_vandalicos', $campos, $values, $cond, $conn);
         commit($conn);
         cerrarconexcion($conn);
         $response[msge] = "El hecho ha sido dado modificado con exito en la BD!";
         print (json_encode($response));
     }catch (Exception $e) {
                            $response[status] = false;
                            $response[msge]="No se ha podido realizar la accion solicitada!!!";
