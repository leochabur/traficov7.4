	...
	$(function() {
                 ...
                 $("#modorden").validate({
                                           submitHandler: function(){
                                                                     ...
                                                                     $.post("/modelo/turismo/modord.php", datos, function(data){
             ...
             <fieldset class='ui-widget ui-widget-content ui-corner-all'>
                       ...
                       <table id='table'>";
                                 ...
                                 $sql = "SELECT o.id, o.km, date_format(fservicio,'%d/%m/%Y') as fservicio, finalizada, date_format(hcitacion, '%H:%i') as hcitacion, date_format(hsalida, '%H:%i') as hsalida, date_format(hfinservicio, '%H:%i') as hfinserv, date_format(hllegada, '%H:%i') as hllegada,
                                                ...
                                                ori.ciudad as origen, des.ciudad as destino, noc.numero
                                                FROM ordenes o
                                                ...
                                                left join numeroOC noc on noc.id_orden = o.id and noc.id_estructura_orden = o.id_estructura
				                 ...
				                 if($row = mysql_fetch_array($query)){
                                            ...
                                            $tabla.="<tr>
                                                         ...
                                                         <td><input id='nombre' name='nombre' type='text' size='30' class='ui-widget ui-widget-content  ui-corner-all {required:true}' readonly value='".utf8_decode($row[nombre])."'></td>
                                                     </tr>
                                                     <tr>
                                                         <td>Hora Salida</td>
                                                         <td><input id='hsalida' name='hsalida' class='hora ui-widget ui-widget-content  ui-corner-all {required:true}' type='text' size='5' readonly value='$row[hsalida]'></td>
                                                     </tr>
                                                     <tr>
                                                         <td>Hora Fin Servicio</td>
                                                         <td><input id='hfinserv' name='hfinserv' class='hora ui-widget ui-widget-content  ui-corner-all {required:true}' type='text' size='5' readonly value='$row[hfinserv]'></td>
                                                     </tr>
                                                     <tr>
                                                         <td>Origen</td>
                                                     ...
                                                     <tr>
                                                         ...
                                                         <td><input id='oc' name='oc' type='text' size='10' value='$row[numero]' class='ui-widget ui-widget-content  ui-corner-all'></td>
                                                     </tr>
                                                     <tr>
