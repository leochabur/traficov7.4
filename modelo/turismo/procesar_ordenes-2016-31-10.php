<?php
  ...
  if ($accion == 'soe'){ //codigo para guardar una orden de un vacio
              ...
              try{
                  ...
                  $values_turismo.=", '$_POST[lugarsalida]','$_POST[lugarllegada]',$_POST[pax], '".$regreso_servicio->format('Y-m-d')."', '$_POST[hsalidaregreso]', '$_POST[hllegadaregreso]'";
                  /////////////////////////////////////////////////////////////////////////////7
                  ...
                  if ($dias == 0){ //significa que el servicio sale y regresa el mismo dia
                     ...
                     $values.=", $cliente, $estructura, $km, '$_POST[nombre]', '$hora_salida_ida', '$hora_salida_ida', '$hora_llegada_regreso', '$hora_llegada_regreso', $_POST[origen], $estructura ,$_POST[destino], $estructura";
              ...
              if ($data = mysql_fetch_array($result)){
                 ...
                 enviarMail("leochabur@gmail.com, kbreitenberger@masterbus.net, rdattoli@masterbus.net, mdepeon@masterbus.net, raguiar@masterbus.net, lemartin@masterbus.net, turismo@masterbus.net", $mail, "Nueva Orden de Turismo Generada");
  ...
  $estructura = STRUCTURED;
     ...
     if(!$_POST[realizada]){ //si el servicio aun no se ha llevado a cabo modifica, tanto la orden como la orden de turismo
              ...
              try{
                  ...
                  enviarMail("leochabur@gmail.com, kbreitenberger@masterbus.net, rdattoli@masterbus.net, mdepeon@masterbus.net, raguiar@masterbus.net, lemartin@masterbus.net, turismo@masterbus.net", $mail, "ORDEN DE TURISMO MODIFICADA");
