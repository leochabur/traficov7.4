<?php
  ...
  if ($accion == 'soe'){ //codigo para guardar una orden de un vacio
              ...
              //   enviarMail("leochabur@gmail.com,mdepeon@masterbus.net,raguiar@masterbus.net,turismo@masterbus.net", $mail, "Nueva Orden de Turismo Generada");
     ...
     if(!$_POST[realizada]){ //si el servicio aun no se ha llevado a cabo modifica, tanto la orden como la orden de turismo
              ...
              /*    backup('ordenes', 'ordenes_modificadas', "(id = $_POST[orden]) and (id_estructura = ".STRUCTURED.")", $conn);
                ...
                //  enviarMail("leochabur@gmail.com,mdepeon@masterbus.net,raguiar@masterbus.net,turismo@masterbus.net", $mail, "ORDEN DE TURISMO MODIFICADA");
              ...
              try{
                       ...
                       print (json_encode($response));
                                      ...
                                      cerrarconexcion($conn);
                                      $response[status] = false;
                                      $response[msge]=$e->getMessage()."$campos - $values - No se ha podido realizar la modificacion solicitada!aa!!";
                                      $response[sql]=$e->getMessage();
                                      print (json_encode($response));
                                      };
      }
