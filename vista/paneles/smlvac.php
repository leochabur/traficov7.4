                 ...
                 $('#cargar').click(function(event){
                                             ...
                                             $.post('/modelo/ordenes/smlvac.php',
                                                    ...
                                                    function(data){
                                                                   ...
                                                                   if (response.status){
                                                                      alert('Los Vacios para el dia '+$('#fecha').val()+' ya han sido generados');
                                                                      alert(response.fecha);

                                                                   }
                                                                   else{
                                                                        $('#simul').html("<div align='center'><img  alt='cargando' src='../ajax-loader.gif' /></div>");
                                                                        $.post('/modelo/ordenes/smlvac.php', $('#load').serialize() , function(datos) {$('#simul').html(datos);});
                                                                   }
                                                                   });
                                             });
...
?>
    ...
    <fieldset class="ui-widget ui-widget-content ui-corner-all">
         ...
         <legend class="ui-widget ui-widget-header ui-corner-all">Diagramar Servicios Vacios</legend>
         <hr align="tr">
         <div>
