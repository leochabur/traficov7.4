	    ...
	    $('#precioNeto').keyup(function() {
		  ...
		  dialog = $( "#dialog-form" ).dialog({
			...
			buttons: {
                ...
                "Agregar viaje y seguir": function(){
                                          form.submit();
                                          }
			},
			close: function() {
	...
	<div id="tabs-1" class="ui-state-highlight ui-corner-all">
         <form class="cmxform" id="addprs" name="commentForm">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Cargar nuevo presupuesto ya confirmado (Solo sector trafico)</legend>
		                 <div id="mensaje"></div>
