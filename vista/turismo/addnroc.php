    ...
    <br><br>
         <form id="upuda">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Cargar Nro. Orden Compra</legend>
		                 <div id="mensaje"> </div>
		                 <fieldset class="ui-widget ui-widget-content ui-corner-all">
                         ...
                         <table border="0" align="center" width="50%" name="tabla">
                                <tr>
                                    <td>Cliente</td>
                                    <td>
                                    <select id="cliente" name="cliente" class="ui-widget ui-widget-content  ui-corner-all">
                                    ...
                                    <td>Desde</td>
                                    <td><input id="fecha" name="fecha"  type="text" size="20"></td>
                                    <td>Hasta</td>
                                    <td><input id="hasta" name="hasta"  type="text" size="20"></td>
                                    <td></td>
                                    <td><input type="button" id="cargar" value="Cargar Ordenes"></td>
                                    <td>
                                    </td>
                                </tr>
                         </table>
