<?php session_start();
  ...
  function menuSegVial(){
        ...
        if ($_SESSION['permisos'][4] >= 1){
           $menu.='<li><a href="#" class="parent"><span>Admin. Taller</span></a>
             ...
             $menu.='<li><a href="'.RAIZ.'/vista/taller/gestionlavados.php"><span>Cargar Lavados</span></a></li>
                     <li><a href="'.RAIZ.'/vista/informes/cria/rsmlvd.php"><span>Informes Lavados</span></a></li>
                     <li><a href="'.RAIZ.'/vista/taller/gstcgl.php"><span>Registrar Cargas Gasoil</span></a></li>
                     <li>
  ...
  function menuTrafico(){
        ...
        if ($_SESSION['permisos'][2] > 1){
           $menu.='<li><a href="'.RAIZ.'/vista/ordenes/modstdg.php"><span>Mod. Estado Diagrama</span></a></li>$verif';
                          ...
                          <div><ul>
                                   ...
                                   <li><a href="#" class="parent"><span>Nuevo Modulo Turismo</span></a>
                                          <div><ul>
                                                   ...
                                                   <li><a href="'.RAIZ.'/vista/turismo/rctct.php"><span>Ver Cta Cte Cliente</span></a></li>
                                          </ul></div>
                                   </li>
                          </ul></div>
                   </li>';                   
      ...
      $menu = '<br><span class="ui-widget">'.$_SESSION['structure_name'].'</span>
        ...
        if ($modulo == 5){
               $menu.='
                             ...
                             <li>
                        <a href="#" class="parent"><span>Lavadero</span></a>
                           <div>
                                <ul>
                                     <li><a href="'.RAIZ.'/vista/taller/gestionlavados.php"><span>Cargar Lavado</span></a></li>
        ...
        $menu.='</li>
         ...
         if ( in_array($_SESSION[userid], array(2,7,17,25))){
