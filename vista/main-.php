<?php session_start();
  ...
  function menuSegVial(){
        ...
        <div>
             <ul>
                 <li><a href="'.RAIZ.'/vista/taller/elrstc.php"><span>Iniciar desvio de compras</span></a></li>
                        ...
                        <a href="#" class="parent"><span>RRHH</span></a>
                           <div>
                                <ul>
                                    ...
                                    <li><a href="'.RAIZ.'/vista/informes/cria/auscnd.php"><span>Resumen Novedades</span></a></li>
                                </ul>
                           </div>
                    </li>                    ';
