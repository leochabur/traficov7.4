	...
	<div id="tabs-1" class="ui-state-highlight ui-corner-all">
         <form class="cmxform" id="commentForm" method="get" action="" name="commentForm">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all"><?php print $edit?"Modificar Descargo":"Ingresar Descargo";?></legend>
		                 <div id="mensaje"></div>
                         <table border="0" align="center" width="50%">
                                <tr>
                                    <td WIDTH="20%">Num. Descargo</td>
                                ...
                                <tr>
                                    ...
                                    <td><select id="destinatario" name="destinatario" class="ui-widget-content  ui-corner-all">
                                                <?php //armarSelectCond($_SESSION['structure']);
                                                       armarSelect ('empleados', 'apellido', "id_empleado", "concat(apellido,', ',nombre)", "not borrado and activo")
                                                ?>
                                        </select>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><textarea id="detalleresolucion" name="detalleresolucion" rows="3" cols="50" class="ui-widget ui-widget-content  ui-corner-all" ><?php echo $edit?$row['detalle_resolucion']:"";?></textarea></td>
                                    <td></td>
                                </tr>

                                <tr>
                                    <td colspan="3" align="right"><input id="envioFormulario" class="boton" type="submit" value="Guardar descargo" name="envioFormulario"></td>
                                </tr>
