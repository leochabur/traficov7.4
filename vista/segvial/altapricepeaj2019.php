	           ...
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
                         ...
                         <tr>
                             ...
                             <?
                               ...
                               print "</tr>";
                               $sql = "SELECT id, concat(id_estacionpeaje,id_tipounidad) as clave, LPAD(round(precio_peaje,2),6,'0') as precio_peaje FROM preciopeajeunidad p where (id_estructura = ".STRUCTURED.")";
                               $result = mysql_query($sql);
                               $importes = array();
                               while ($data = mysql_fetch_array($result)){
