    ...
    <br><br>
         <form id="upuda">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 ...
		                 <div id="mensaje"> </div>
		                 <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Unidades pertenecientes a:</legend>
                         <table border="0" align="center" width="50%" name="tabla">
                                <tr>
                                    <td WIDTH="20%">Propietarios</td>
                                    <td><select id="propietario" name="propietario" class="select ui-widget ui-widget-content  ui-corner-all">
                                                <option value="0">TODOS LOS INTERNOS</option>
                                                <?php
                                    ...
                                    <td><select id="state" name="state" class="state ui-widget ui-widget-content  ui-corner-all">
