    ...
    <br><br>
         <form id="upuda">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Modificar Unidad</legend>
		                 <div id="mensaje"> </div>
		                 <fieldset class="ui-widget ui-widget-content ui-corner-all">
                         ...
                         <table border="0" align="center" width="50%" name="tabla">
                                <tr>
                                    ...
                                    <td><select id="unidad" name="unidad" class="ui-widget ui-widget-content  ui-corner-all"  validate="required:true">
                                                <?php
                                                     if (!in_array($_SESSION['userid'], array(0 => 9, 1 => 102)))
                                                      armarSelect('unidades', 'CAST(interno as UNSIGNED)', 'id', 'interno', "(id_estructura = ".STRUCTURED.") AND (activo)");
                                                     else
