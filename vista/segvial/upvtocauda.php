...
<script type="text/javascript">
                          $(document).ready(function(){
                                                       $("#cargar").button().click(function(){
                                                                                              ...
                                                                                              $.post("/modelo/segvial/upvtocauda.php", datos, function(data){$('#data').html(data);});
                                                       });
    ...
    <br><br>
         <form id="upuda">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Renovar Poliza Seguro</legend>
		                 <div id="mensaje"> </div>
		                 <fieldset class="ui-widget ui-widget-content ui-corner-all">
                         ...
                         <table border="0" align="center" width="50%" name="tabla">
                                <tr>
                                    ...
                                    <td><select id="unidad" name="unidad" class="ui-widget ui-widget-content  ui-corner-all"  validate="required:true">
                                                <?php
                                                     armarSelect('unidades', 'CAST(interno as UNSIGNED)', 'id', 'interno', "(id_estructura in (SELECT id_estructura FROM usuariosxestructuras where id_usuario = $_SESSION[userid])) and (activo)");
                                                ?>
                                        </select>
                                    </td>
                                    <td>
