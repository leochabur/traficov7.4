...
<script type="text/javascript">
                          $(document).ready(function(){
                                                       ...
                                                       $.post("/modelo/segvial/readcgo.php",{accion:'ldcond'}, function(data){
                                                                                                                                                                                   ...
                                                                                                                                                                                   <?php
                                                            if (isset($_GET['cn'])){
                                                                         print "$('#conductores option[value=$_GET[cn]]').attr('selected','selected');$('#conductores').selectmenu({width: 350});";
                                                                         ?>
                                                                         var datos = $('#upuda').serialize();
                                                                                              $('#dats').html("<div align='center'><img  alt='cargando' src='../ajax-loader.gif' /></div>");
                                                                                              $.post("/modelo/segvial/readcgo.php", datos, function(data){  $('#dats').html(data);
    ...
    <br><br>
         <form id="upuda">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Pedidos de Explicacion generados</legend>
		                 <div id="mensaje"> </div>
		                 <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Filtrar Pedidos de Explicacion</legend>
                         <table border="0" align="center" width="50%" name="tabla">
                                ...
                                <tr>
                                    <td>Desde</td>
                                    <td><input id="desde" name="desde"  type="text" size="20" value="<?php print $_GET['ds'];?>" class="ui-widget ui-widget-content" ></td>
                                    <td>Hasta</td>
                                    <td><input id="hasta" name="hasta" type="text" size="20" value="<?php print $_GET['hs'];?>" class="ui-widget ui-widget-content"></td>
                                    <td>
                                        <input type="button" value="Cargar Pedidos Explicacion" id="cargar">
                                    </td>
                                </tr>
                         </table>
                         </fieldset>
