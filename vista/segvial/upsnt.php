...
//id, id_empleado, acumulado, substro, siniestro_numero, fecha_siniestro, hora_siniestro, estado_clima, cod_ubicacion, calle1, calle2, id_localidad, tipo_lesion, resp_estimada, tipo_maniobra, norma_no_respetada, cobertura_afectada, id_coche, id_cliente, compania_seguro, numero_poliza, indemnizacion_a_terceros, numero_estudio, usr_alta, fecha_alta, usr_edit, fecha_edit, usr_baja, fecha_baja, borrada, id_estructura,
     ...
     if(isset($_GET['nro'])){
          ...
          $sql = "SELECT date_format(fecha_siniestro, '%d/%m/%Y') as fecha, time_format(hora_siniestro, '%H:%i') as hora,
                         latitud, longitud, id_estructura, s.id, s.id_empleado, id_cliente, estado_clima, calle1, calle2, cod_ubicacion,
                         tipo_lesion, resp_estimada, id_coche, cobertura_afectada, compania_seguro, tipo_maniobra, norma_no_respetada,
                         numero_poliza, id_localidad, costos_reparacion_unidades, costos_administrativos, num_sin_asignado, id_estado, id_accionCorrectiva,
                         date_format(fecha_accion_correctiva, '%d/%m/%Y') as fecha_accion_correctiva, obs_accion_correctiva,
                         if (afecta_estadistica, 'checked','') as af, if (potencial_grave, 'checked','') as pot,
                         if (resp_propia, 'checked','') as resp_propia, id_responsable, tipo_accion_correctiva,
                         date_format(fecha_implementacion, '%d/%m/%Y') as imple,
                         date_format(fecha_verificacion, '%d/%m/%Y') as veri, d.nro_descargo as descargo
                  FROM siniestros s
                  LEFT JOIN minuta_de_reunion mr on mr.id_siniestro =  s.id
				  LEFT JOIN descargos d ON d.id_siniestro = s.id
                  WHERE s.id = $_GET[nro]";
                  try{
...
<script type="text/javascript" src="<?php echo RAIZ;?>/vista/js/validate-form/jquery.metadata.js"></script>
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDLhyBTRa0pomRl8I42WmIcD1B6RpCjfCc&libraries=adsense&language=es"></script>
 <script>
...
function geocodeResult(results, status) {
	...
	$(function() {
        ...
        $(':button').button();
        $(':submit').button();
		$("#fsin, #feacc, #feimacc, #feveracc").datepicker({
                                    dateFormat : 'dd/mm/yy'
                                   });
       ...
       <? echo $edit?"$('#estr option[value=$row[id_estructura]]').attr('selected','selected');":"";
          ...
          echo $edit?"$('#acccor option[value=$row[id_accionCorrectiva]]').attr('selected','selected');":"";
          echo $edit?"$('#solacccor option[value=$row[id_responsable]]').attr('selected','selected');":"";
          echo $edit?"$('#tipoacccor option[value=$row[tipo_accion_correctiva]]').attr('selected','selected');":"";
                                  ...
                                  submitHandler: function(){
                                                            ...
                                                            $.post("/modelo/segvial/upsnt.php", datos, function(data){
                                                                                                                      ...
                                                                                                                      <?php if ($edit){   ?>
                                                                                                                               ...
                                                                                                                               if (response.mtasn){
                                                                                                                                window.location.href = "/modelo/segvial/mta.php?nro="+response.mtanro;
                                                                                                                               }
                                                                                                                               else{
                                                                                                                                    history.back();
                                                                                                                               }
                                                                                                                      <?php }
                                                                                                                           ...
                                                                                                                           $('#commentForm')[0].reset();
                                                                                                                            window.location.href = "/vista/segvial/updcgo.php";
                                                                                                                      <?php }?>
	           ...
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
                         ...
                         <table border="0" align="center" width="50%">
                                ...
                                ?>
                                	...
                                	<tr>
                                	<td WIDTH="20%">Pedido de Explicacion Vinculado</td>
                                	<td colspan="2"><input id="ndescar" size="8" name="ndescar" class="ui-widget-content ui-corner-all" readonly value="<?php echo $edit?$row['descargo']:"";?>"/></td>
                                			</tr>
                                 <?php                               }
                                ?>
                                <tr>
                                    ...
                                    <td><select id="climasin" name="climasin" title="Please select something!"  class="ui-widget-content  ui-corner-all"  validate="required:true">
                                                <?php
                                                	if ($edit){                                          
                                                		...
                                                		armarSelect('estadoClima', 'estado', 'id', 'estado', "activo");
                                                	}
                                ...
                                <tr>
                                    ...
                                    <td><select id="ubicacionsin" name="ubicacionsin" title="Please select something!"  class="ui-widget-content  ui-corner-all"  validate="required:true">
                                                <?php
                                                     armarSelect('codUbicacionSiniestro', 'codigo', 'id', 'codigo', "activo");
                                                ?>
                                        </select>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td WIDTH="20%">Situacion del siniestro</td>
                                ...
                                <tr>
                                    <td WIDTH="20%">Conducta apropiada no realizada</td>
                                ...
                                <?php if (false) {?>
                                <tr>
                                    <td WIDTH="20%"><label for="fservicio">Fecha Accion Correctiva</label></td>
                                    <td><input id="feacc" name="feacc" class="ui-widget ui-widget-content  ui-corner-all" minlength="2" value="<?php echo $row['fecha_accion_correctiva'];?>"/></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td WIDTH="20%"><label for="fservicio">Fecha Implementacion Accion Correctiva</label></td>
                                    <td><input id="feimacc" name="feimacc" class="ui-widget ui-widget-content  ui-corner-all" minlength="2" value="<?php echo $row['imple'];?>"/></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td WIDTH="20%"><label for="fservicio">Fecha Verificacion Accion Correctiva</label></td>
                                    <td><input id="feveracc" name="feveracc" class="ui-widget ui-widget-content  ui-corner-all" minlength="2" value="<?php echo $row['veri'];?>"/></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td WIDTH="20%">Solicitante accion correctiva</td>
                                    <td><select id="solacccor" name="solacccor" class="ui-widget-content  ui-corner-all">
                                                <?php
                                                     armarSelect('usuarios', 'upper(apenom)', 'id', 'apenom', "activo");
                                                ?>
                                        </select>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td WIDTH="20%">Accion Correctiva</td>
                                    <td><select id="acccor" name="acccor" class="ui-widget-content  ui-corner-all">
                                                <option value="0">NO DETALLA</option>
                                                <?php
                                                     armarSelect('accionesCorrectivasSiniestros', 'accion', 'id', 'accion', "");
                                                ?>
                                        </select>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td WIDTH="20%">Tipo Accion Correctiva</td>
                                    <td><select id="tipoacccor" name="tipoacccor" class="ui-widget-content  ui-corner-all">
                                                <option value="0">NO DETALLA</option>
                                                <?php
                                                     armarSelect('accioncorrectivaminuta', 'accion', 'id', 'accion', "");
                                                ?>
                                        </select>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td WIDTH="20%">Detalle Accion Correctiva</td>
                                    <td><textarea rows="4" cols="60" name="detresin"><?php echo $row['obs_accion_correctiva'];?></textarea>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td WIDTH="20%">Pagos a terceros</td>
                                ...
                                <tr>
                                    <td WIDTH="20%">Reclamado a tercero</td>
                                    <td colspan="2"><input type="checkbox" <?php echo $edit?$row['resp_propia']:"";?> name="respropia"></td>
                                </tr>
                                <tr>
                                    <td WIDTH="20%">Recupero por siniestros</td>
                                ...
                                <tr>
                                    <td WIDTH="20%">Afecta Estadisticas</td>
                                    <td colspan="2"><input type="checkbox" <?php echo $edit?$row['af']:""; if(!$edit) echo "checked";?> name="afes"></td>
                                </tr>
                                <tr>
                                    <td WIDTH="20%">Potencial Grave/Muerte</td>
                                    <td colspan="2"><input type="checkbox" <?php echo $edit?$row['pot']:"";?> name="potencial"></td>
                                </tr>
                                <tr>
                                    <td colspan="3">
<div><input type="text" maxlength="100" id="address" placeholder="Dirección" /> <input type="button" id="search" value="Buscar Direccion" /></div>
<br/>
