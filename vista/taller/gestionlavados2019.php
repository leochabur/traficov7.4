...
?>
    <br><br>
                              ...
                              $internos = $entityManager->createQuery('SELECT u, u.interno as inerno
                                                                      FROM Unidad u  
                                                                      LEFT JOIN u.propietario pro
                                                                      LEFT JOIN u.calidad ca
                                     ...
                                     foreach ($results as $row) {
                                                ...
                                                foreach ($acciones as $acc) {
                                                   if (!$acc->getComenta()){
                                                        ...
                                                        if (!is_null($row[0]) && ($row[0]->admiteAccion($acc)))
                                                        {   
