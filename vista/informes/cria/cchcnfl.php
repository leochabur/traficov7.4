...
<script type="text/javascript">
                          $(document).ready(function(){
                                                       ...
                                                       $("#cargar").button().click(function(){
                                                                                              ...
                                                                                              $.post("/modelo/informes/cria/cchcnfl.php", {accion:'reskm', emp:$('#titular').val(), flet:$('#fletero').val(), str:$('#str').val(), desde: $('#desde').val(), hasta: $('#hasta').val()}, function(data){  $('#dats').html(data);
                                                                                                                                                                           });
                                                       });
                                                       $('#str').selectmenu({width: 350});
                                                       $('#str').change(function(){
                                                                                  $.post("/modelo/informes/cria/cchcnfl.php",{accion:'ldemp',name:'titular', str:$('#str').val()}, function(data){
                                                                                                                                                                                   $('#clis').html(data);
                                                                                                                                                                                   });
                                                                                  $.post("/modelo/informes/cria/cchcnfl.php",{accion:'ldemp',name:'fletero', str:$('#str').val()}, function(data){
                                                                                                                                                                                   $('#emps').html(data);
                                                                                                                                                                                   });
                                                                                  });
                                                       $.post("/modelo/informes/cria/cchcnfl.php",{accion:'ldemp',name:'titular', str:$('#str').val()}, function(data){
    ...
    <br><br>
         <form id="upuda">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Resumen Km Conduccion</legend>
		                 <div id="mensaje"> </div>
		                 <fieldset class="ui-widget ui-widget-content ui-corner-all">
                         ...
                         <table border="0" align="center" width="70%" name="tabla">
                                ...
                                <tr>
                                    <td>Internos pertenecientes a:</td>
                                    <td id="clis">
                                    </td>
                                    </tr>
                                <tr>
                                    <td>Conducidos por personal de:</td>
                                    <td id="emps">
                                    </td>
                                    </tr>
                                    <tr>
