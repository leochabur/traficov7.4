                          ...
                          $(document).ready(function(){
                                                       ...
                                                       $("#cargar").button().click(function(){
                                                                                              ...
                                                                                              $.post("/modelo/informes/cria/reccliint.php", 
                                                                                                datos, function(data){$('#dats').html(data);
                                                                                                                                                                           });
                                                       });

                                                       $('#str').change(function(){
                                                                                  $.post("/modelo/informes/cria/reccliint.php",{accion:'ldcli', str:$('#str').val()}, 
                                                                                    function(data){                                                                   $('#clis').html(data);
                                                                                                  });
                                                                                  });
                                                       $("#str option[value=1]").attr("selected", "selected");
                                                       $('#str, #type').selectmenu({width: 350});
                                                       $.post("/modelo/informes/cria/reccliint.php",{accion:'ldcli', str:$('#str').val()}, function(data){$('#clis').html(data);});
    ...
    <br><br>
         <form id="upuda">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Asignacion de servicios (Facturacion)</legend>
		                 <div id="mensaje"> </div>
		                 <fieldset class="ui-widget ui-widget-content ui-corner-all">
                         ...
                         <table border="0" align="center" width="50%" name="tabla">
                                <tr>
                                    ...
                                    <tr>
                                      <td>Mostrar</td>
                                      <td>Servicios Asignados<input type="radio" name="accion" value="detsrv">Servicios NO Asignados<input type="radio" name="accion" value="saisg"></td>
                                    </tr>
                                    <tr>

                                    <td colspan="4" align="right">
                                        <input type="button" value="Cargar Servicio" id="cargar">
                                    </td>
                                </tr>
                         </table>
                         </fieldset>
