         ...
         <form id="upuda">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
                         ...
                         <table border="0" align="center" width="50%" name="tabla">
                                ...
                                <tr>
                                    <td colspan="3" align="right"><input type="button" value="Lavados por Tipo Accion" id="loadTypo"></td>
                                    <td colspan="3" align="right"><input type="button" value="Lavados por Responsable" id="loadRspo"></td>
                                    <td colspan="3" align="right"><input type="button" value="Lavados del Periodo" id="loadPdo"></td>
                                    <td align="right"><input type="button" value="Ultimos Lavados" id="loadLast"></td>
                                </tr>
                         </table>
                         <br>
                         <div id="dats"></div>
