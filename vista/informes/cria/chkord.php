...
<script type="text/javascript">
                          $(document).ready(function(){
                                                       ...
                                                       $("#cargar").button().click(function(){
                                                                                              ...
                                                                                              $.post("/modelo/informes/cria/chkord.php", data, function(data){  $('#dats').html(data);
                                                                                                                                                                           });
                                                       });

                                                       $('#str').change(function(){
                                                                                  $.post("/modelo/informes/cria/chkord.php",{accion:'ldcli', str:$('#str').val()}, function(data){
                                                                                                                                                                                   $('#clis').html(data);
                                                                                                                                                                                   });
                                                                                  });
                                                       $("#str option[value=1]").attr("selected", "selected");
                                                       $('#str, #type').selectmenu({width: 350});
                                                       $.post("/modelo/informes/cria/chkord.php",{accion:'ldcli', str:$('#str').val()}, function(data){$('#clis').html(data);});
    ...
    <br><br>
         <form id="upuda">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Informe chequeo de ordenes</legend>
		                 <div id="mensaje"> </div>
		                 <fieldset class="ui-widget ui-widget-content ui-corner-all">
                         ...
                         <table border="0" align="center" width="50%" name="tabla">
                                <tr>
                                    ...
                                    <td>Chequeos</td>
                                    <td>
                                        Todos<input type="radio" name="chk" checked value="chkt">Fuera Horario<input type="radio" name="chk" value="chkfh">
                                    </td>
                                    <td>Respuestas</td>
                                    <td>
                                        Todas<input type="radio" name="rpta" checked value="rtat">Negativas<input type="radio" name="rpta" value="rtan">
                                    </td>
                                    </tr>
                                    
                                    <tr>
                                    <td>Llegadas a Planta</td>
                                    <td>
                                        Todas<input type="radio" name="llp" checked value="lltp">Fuera Horario<input type="radio" name="llp" value="llfh">
                                    </td>
                                    <td></td>
                                    <td>
                                    </td>
            ...
            <input type="hidden" name="accion" id="accion" value="res">
         </form>
