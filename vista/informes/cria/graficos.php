...
<script type="text/javascript">
                          $(document).ready(function(){
                                                       ...
                                                       $("#cargar").button().click(function(){
                                                                                              $('#dats').html("<div align='center'><img  alt='cargandos' src='../../ajax-loader.gif' /></div>");
                                                                                              var des = $('#desde').val();

                                                                                              var url = "./diagint.php?desde="+des;

                                                                                              $('#dats').html("<div align='center'><img  alt='cargando' src="+url+" /></div>");
    ...
    <br><br>
         <form id="upuda">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Diagramacion Unidades</legend>
		                 <div id="mensaje"> </div>
		                 <fieldset class="ui-widget ui-widget-content ui-corner-all">
