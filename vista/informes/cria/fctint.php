     ...
     if (isset($_POST['cliente'])){
        try{
         // $cliente = getCliente($_POST['cliente'], $_SESSION[structure]);
          ...
          $facturacion = facturacionCliente($_POST['cliente']);
          $desde = DateTime::createFromFrmat('Y-m-d', $_POST['desde']); 
          $hasta = DateTime::createFromFrmat('Y-m-d', $_POST['hasta']); 
