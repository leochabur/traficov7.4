...
<script type="text/javascript">
                          $(document).ready(function(){
                                                       ...
                                                       $("#cargar").button().click(function(){
                                                                                              ...
                                                                                              $.post("/modelo/informes/cria/rpty.php", {mes:$('#mes').val(), anio:$('#anio').val(), cli:$('#clientes').val(), str:$('#str').val()}, function(data){$('#files').html(data);});
                                                       });
    ...
    <br><br>
         <form id="upuda">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Reportes cliente</legend>
		                 <div id="mensaje"> </div>
		                 <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Filtrar reportes</legend>
                         <table border="0" align="center" width="50%" name="tabla">
                                <tr>
                                    ...
                                    <td>A&ntilde;o</td>
                                    <td><input id="anio" name="anio" type="text" size="20"></td>
                                    </tr>
                                    <tr>
                                    <td colspan="4" align="right">
                                        <input type="button" value="Cargar Archivos" id="cargar">
                                    </td>
                                </tr>
                         </table>
<div id="files">
