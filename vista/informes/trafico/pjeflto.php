...
<script type="text/javascript">
                          $(document).ready(function(){
                                                       ...
                                                       $("#cargar").button().click(function(){
                                                                                              ...
                                                                                              $.post("/modelo/informes/trafico/pjeflto.php", {accion:'reskm', str:$('#str').val(),
    ...
    <br><br>
         <form id="upuda">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Peajes por Empleador</legend>
		                 <div id="mensaje"> </div>
		                 <fieldset class="ui-widget ui-widget-content ui-corner-all">
                         ...
                         <table border="0" align="center" width="50%" name="tabla">
                                <tr>
                                    <td>Empleadores</td>
                                    <td>
                                        <select id="flt" name="flt" class="ui-widget ui-widget-content  ui-corner-all">
                                                <option value="0">Todos</option>
                                                <?php
                                                     armarSelect('empleadores', 'razon_social', 'id', 'razon_social', "$_SESSION[structure]");
                                                ?>
                                        </select>
                                    </td>
                                </tr>
