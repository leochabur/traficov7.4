 ...
 <script>
	$(function() {
        ...
        onSelect: function(dateText, inst) {
                                         ...
                                         $.post("/modelo/servicios/agsrv.php",{cli: cliente, accion: 'lcr', fecha: $("#fecha").val()},function(data){
                                                                                                                    $("#serv-cli").html(data);
                                                                                                                   });
                }});
	...
	<div id="tabs-1" class="ui-state-highlight ui-corner-all">
         <form class="cmxform" id="commentForm" method="get" action="">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Seguimiento diagrama trabajo</legend>
                         <table border="0" align="center">
                                <tr>
                                    <td WIDTH="20%">Fecha a seguir</td>
                                    <td>
                                        <input type="text" size="20" id="fecha" name="fecha">
                                    </td>
                                    <td>
