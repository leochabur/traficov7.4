...
*/
		...
		foreach ($fact->getTarifas() as $tarifa) {
			$tarifas.="<tr data-id='".$tarifa->getId()."'>
							<td>$tarifa</td>
							<td><a href='#' data-id='cron' class=''>".count($tarifa->getCronogramas())."</a></td>
							<td><a href='#' data-id='day' class=''>".count($tarifa->getDiasSemana())."</a></td>
							<td><a href='#' data-id='type' class=''>".count($tarifa->getTarifasTipoVehiculo())."</a></td>
