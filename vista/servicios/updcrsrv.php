 ...
 <script>
	$(function() {
        ...
        $("#cliente").change(function(){
                                         ...
                                         $.post("../paneles/modserv/comboDB.php",{cli: cliente, accion: 'lcr'},function(data){
                                                                                                                      $("#serv-cli").html(data);
                                                                                                                      $('#servicios').selectmenu({width: 350});
                                                                                                                     })
	...
	<div id="tabs-1" class="ui-state-highlight ui-corner-all">
         <form class="cmxform" id="commentForm" method="get" action="">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Modificar Cronograma</legend>
