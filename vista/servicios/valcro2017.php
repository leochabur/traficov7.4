...
<script type="text/javascript">
                          $(document).ready(function(){
                                                       ...
                                                       $("#cargar").button().click(function(){
                                                                                              ...
                                                                                              var tra = 0;
                                                                                              if($('#fctr').attr('checked')){
                                                                                                  tra = 1;
                                                                                                  $.post("/modelo/servicios/valcro.php", {ftramo:1, accion:"updtpo", cli:$('#clientes').val(), str:$('#str').val()});
                                                                                              }
                                                                                              else{
                                                                                                   $.post("/modelo/servicios/valcro.php", {ftramo:0, accion:"updtpo", cli:$('#clientes').val(), str:$('#str').val()});
                                                                                              }
                                                                                              $.post("/modelo/servicios/valcro.php", {accion:'load', cli:$('#clientes').val(), fctr:tra, str:$('#str').val(),desde:$('#desde').val(),hasta:$('#hasta').val()}, function(data){$('#files').html(data);});
                                                       });
	           ...
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
                         ...
                         <table border="0" align="center" width="50%" name="tabla">
                                <tr>
                                    ...
                                    <td coslpan="">
                                        <input type="checkbox" id="fctr" name="fctr">
                                    </td>
                                    </tr>
                                    <tr>
                                        <td>Desde</td>
