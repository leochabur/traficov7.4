 ...
 <script>
	$(function() {
        ...
        $("#cliente").change(function(){
                                         ...
                                         $('#srvcron').empty();
                                         $.post("/modelo/rrhh/nvdas/nvups.php",{cli: cliente, accion: 'lcr'},function(data){
                                                                                                                    $("#serv-cli").html(data);
                                                                                                                   });
                                        });
...
<?php
          print "<script type=\"text/javascript\">
                    ...
                    \$(\"#serv-cli\").html(\"<div align='center'><img  alt='cargando' src='../../ajax-loader.gif' /></div>\");
                    \$.post(\"/modelo/rrhh/nvdas/nvups.php\",{cli: $opcion, accion: 'lcr'}, function(data){\$(\"#serv-cli\").html(data);});
                </script>";
?>
</HTML>
