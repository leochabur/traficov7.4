...
<script type="text/javascript">
                          $(document).ready(function(){
                                                       ...
                                                       $("#cargar").button().click(function(){
                                                                                              ...
                                                                                              $.post("/modelo/rrhh/ictvo/geninc.php", {accion:'res', str:$('#str').val(), desde: $('#desde').val(), hasta: $('#hasta').val(), cgo:$('#cargo').val()}, function(data){  $('#dats').html(data);
                                                                                                                                                                           });
                                                       });
                                                       $('#str, #cargo').selectmenu({width: 350});
    ...
    <br><br>
         <form id="upuda">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Programa de Incentivos</legend>
		                 <div id="mensaje"> </div>
		                 <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Configurar Parametros</legend>
                         <table border="0" align="center" width="50%" name="tabla">
                                ...
                                <tr>
                                    <td>Puesto</td>
                                    <td>
                                        <select id="cargo" name="cargo" class="ui-widget ui-widget-content  ui-corner-all">
                                                <?php
                                                     armarSelect('cargo', 'descripcion', 'id', 'descripcion', "");
                                                ?>
                                        </select>
                                    </td>
                                </tr>
                                    ...
                                    <td>
                                        <input type="button" value="Generar Informe" id="cargar">
                                    </td>
                                </tr>
                         </table>
                         </fieldset>
