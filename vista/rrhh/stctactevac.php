...
<script type="text/javascript">
                          $(document).ready(function(){
                                                       $("#cargar").button().click(function(){
                                                                                              ...
                                                                                              $.post("/modelo/rrhh/stctactevac.php", datos, function(data){$('#data').html(data);});
                                                       });
    ...
    <br><br>
         <form id="upuda">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Estado Vacaciones Personal</legend>
		                 <div id="mensaje"> </div>
		                 <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Seleccionar Empleado</legend>
                         <table border="0" align="center" width="50%" name="tabla">
                                <tr>
                                    <td>Empleados</td>
                                    <td><select id="emple" name="emple" class="ui-widget ui-widget-content  ui-corner-all"  validate="required:true">
                                                <?php
                                                     $conn = conexcion();
