<?php session_start();
  ...
  function getNovSegVial(){
           if ($_SESSION['modaf'] == 4){ //el usuario es operador del modulo de Seg Vial por lo tanto solo recibe notificaciones de Seg Vial
              $sqldefault = "SELECT id FROM unidades u where (u.id not in (SELECT idunidad FROM tipovencimientoporinterno group by idunidad)) and (activo)";
  ...
  function menuSegVial(){
           ...
           if ((array_key_exists(4, $_SESSION['permisos'])) || (array_key_exists(2, $_SESSION['permisos']))){
                ...
                $menu.='<li><a href="#" class="parent"><span>VTV</span></a>
                    <div><ul>';
        ...
        <div>
             <ul>
                 <li><a href="#" class="parent"><span>Unidades</span></a>
                    <div>
                         <ul>
                             <li><a href="'.RAIZ.'/vista/taller/asigdist.php"><span>Distribucion Cubiertas</span></a></li>
                         </ul>
                    </div>
                 </li>
             </ul>
        ...
        $menu.='</li>
         ...
         $menu.='</ul>
           ...
           if ($_SESSION['permiso'] > 8){
                             ...
                             $menu.='<li><a href="'.RAIZ.'/vista/informes/cria/kmrecli.php"><span>Servicios por Cliente</span></a></li>
