...
?>
    ...
    <fieldset class="ui-widget ui-widget-content ui-corner-all">
         ...
         <div id="tablaordenes">
                            ...
                            if ($cargar)
                            {
                                 $ordenes = "SELECT time_format(o.llega, '%H:%i') as llega, orden, nomOrden, 
                                                    time_format(o.cita, '%H:%i') as cita, time_format(o.sale, '%H:%i') as sale, 
                               ...
                               //  die($ordenes);
                                 $con = conexcion();
                                 $query = mysql_query($ordenes, $con)or die($ordenes);
