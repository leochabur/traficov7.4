              ...
              <table id='table' align="center" class="tablesorter" border="0" width="100%">
                     <thead>
            	            <tr class="">
                                ...
                                <?php
                                     if (($_SESSION['userid'] == 25) ||($_SESSION['userid'] == 18))
                     ...
                     <tbody>
                            <?php
                                 $cond_fecha = "(fservicio = '$fecha')";
                                 $camposHS = "date_format(hcitacion, '%H:%i') as hcitacion,
                                              date_format(hllegada, '%H:%i') as hllegada,
                                              date_format(hsalida, '%H:%i') as hsalida,
                                              date_format(hfinservicio, '%H:%i') as hfinserv";
                                 if ($cantTripulacion > 2){
                                    $camposHS = "if ('$fecha' = date(citacion), time_format(citacion, '%H:%i'), '00:00') as hcitacion,
                                                 if ('$fecha' = date(llegada), time_format(llegada, '%H:%i'), '23:59') as hllegada,
                                                 if ('$fecha' = date(salida), time_format(salida, '%H:%i'), '00:00') as fsalida,
                                                 if ('$fecha' = date(finalizacion), time_format(finalizacion, '%H:%i'), '23:59') as hfinserv";
                                    $tripulacion = "LEFT JOIN tripulacionXOrdenes txo ON txo.id_orden = o.id AND txo.id_estructura_orden = o.id_estructura
                                                    ...
                                                    LEFT JOIN horarios_ordenes_sur hs ON hs.id_orden = o.id and hs.id_estructura_orden = o.id_estructura";
                                    ...
                                    $cond_fecha = "('$fecha' between date(citacion) and date(finalizacion)) or (fservicio = '$fecha')";
                                 }
                                 ...
                                 $sql = "SELECT o.id,
                                                ...
                                                interno,
                                                ch1.id_empleado,
                                                ch2.id_empleado as id_empleado2,
                                                suspendida,
                                                checkeada,
                                                emp.color
                                                $camposTripulacion
                                                       ...
                                                       WHERE  $cond_fecha and (not borrada) and (not suspendida) and (o.id_estructura = $_SESSION[structure]) and (finalizada in ($_SESSION[todas]))
                                         UNION
                                         SELECT n.id as id,
                                                0 as finalizada,
                                                '00:00' as hcitacion,
                                                ...
                                                '00:00' as hfinserv,
                                                '00:00' as hllegada,
                                                cn.nov_text as nombre,
                                                concat(e.apellido, ', ',e.nombre) as chofer1,
                                                '' as razon_social,
                                                '' as chofer2,
                                                '' as comentario,
                                                '' as interno,
