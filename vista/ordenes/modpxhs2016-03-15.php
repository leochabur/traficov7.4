...
?>
    ...
    <fieldset class="ui-widget ui-widget-content ui-corner-all">
                     ...
                     <tbody>
                            <?php
                                 ...
                                 $sql = "SELECT o.id as id_orden,
                                         o.finalizada, date_format(o.hllegada, '%H:%i') as hllegada,
                                         date_format(o.hsalida, '%H:%i') as hsalida,
                                         date_format(o.hfinservicio, '%H:%i') as hfinserv,
       o.nombre,
       ...
       i_v,
       cantasientos,
       date_format(ho.hllegada, '%H:%i') as hllegadastd,
       date_format(ho.hsalida, '%H:%i') as hsalidastd
FROM ordenes o
                               ...
                               //  die ("khkhkj".mysql_num_rows($query));
				                 while($row = mysql_fetch_array($query)){
					                        ...
					                        print "<tr>
                                                       ...
                                                       <td class=\"$tdclass\"><input class='hora $hiddenv' type='text' size='5' value='$row[hsalida]' id='hsalida-$id'></td>
                                                       <td class=\"$tdclass\"><input class='hora $hiddeni' type='text' size='5' value='$row[hllegada]' id='hllegada-$id'></td>
