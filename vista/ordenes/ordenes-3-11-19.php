                            ...
                            <?php
				                 ...
				                 while($row = mysql_fetch_array($query)){
					                        ...
					                        $body.="<tr data-id='$id' style='height: 20px;' name='$name'>
                                                       ...
                                                       <td $tdclass><div><a href='/vista/segvial/posint.php?int=$row[interno]' target='_blank' onClick=\"window.open(this.href, this.target, 'width=900,height=650'); return false;\"><div style='color:#$row[color];' id='id_micro-$id'>$row[interno]</div></a></div></td>
                                            ...
                                            $body.="<td $tdclass><div class='$divclass' id='razon_social-$id'>".($row['razon_social'])."</div></td>
                                                       <td $tdclass><div $observa id='comentario-$id-updcmt'>$row[comentario]</div></td>
                                                       $horarioSTD
                                                       $isOrden
