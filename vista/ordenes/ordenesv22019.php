    ...
    <div class="container">
            ...
            <form id="load" method="post" class="text-left border-light p-1">
               ...
               <div class="row clase p-2">
                    <div class="col-2 amber accent-3">&Oacute;rden finalizada</div>
                           ...
                           <tbody class="table-condensed">
                               ...
                               {                  
                                    ...
                                    elseif ($row['finalizada']){
                                      $tdclass = "amber accent-3 table-condensed";
                                    }
...
<div class="modal fade" id="viewDiagrama" tabindex="-1" role="dialog" aria-labelledby="bodyDiagrama"
  ...
  v34(function() {
                    v34('.viewdiag').on('click', function (e) {
                                                            v34('#bodyDiagrama').html('Diagrama de trabajo de:  '+ $(this).data('apenom'));
                                                            ...
                                                            v34('.modal-body-view').load('/modelo/ordenes/ordenesV2.php', {accion:'diagrama', cond: $(this).data('conductor')});
                    ...
                    v34('.fa-edit').on('click', function (e) {
                                                            v34("#position").val(v34(this).offset().top);
                                                            v34('#exampleModalLabel').html('Detalle de la orden '+ $(this).data('id'));
                                                            v34('.modal-body').load('/modelo/ordenes/ordenesV2.php', {accion:'load', orden: $(this).data('id')});
