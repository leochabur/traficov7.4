	...
	$(function() {
                 ...
                 $("div.observa").editable('/modelo/procesa/mod_ordenes.php',  {type      : 'textarea',
                                                                        ...
                                                                        value: $(this).val(),
                                                                                      cancel    : 'Cancelar',
                                                                                      submit    : 'Guardar'});
                 $("#dialog-ch-driver, #comentario_orden, #dialog-ch-interno").dialog({autoOpen: false, width: 650, modal: true});
...
?>
    ...
    <fieldset class="ui-widget ui-widget-content ui-corner-all">
                                      ...
                                      /*    $cargapax = "";
                                           ...
                                           // if (($_SESSION['userid'] == 25) || ($_SESSION['userid'] == 18)|| ($_SESSION['userid'] == 37))
					                        ...
					                        $body.="<tr data-id='$id' style='height: 20px;' name='$name'>
                                                       ...
                                                       <td $tdclass id='int1-$id'><div id='int2-$id'><a href='/vista/segvial/posint.php?int=$row[interno]' target='_blank' onClick=\"window.open(this.href, this.target, 'width=900,height=650'); return false;\"><div style='color:#$row[color];'>$row[interno]</div></a></div></td>
                                                       <td $tdclass id='ch11-$id'><div id='ch12-$id' style='cursor: pointer;' onclick='mostrarDiag($row[id_empleado]);'>".($row['chofer1'])."</div></td>
                                                       <td $tdclass id='ch21-$id'><div id='ch22-$id' style='cursor: pointer;' onclick='mostrarDiag($row[id_empleado2]);'>".($row['chofer2'])."</div></td>";
                                         /* if ($cantTripulacion > 2){
                                            ...
                                            $body.="<td $tdclass id='cli1-$id'><div class='$divclass' id='razon_social-$id'>".($row['razon_social'])."</div></td>
                                                       <td $tdclass id='cmt1-$id'><div id='comentario-$id-updcmt'>$row[comentario]</div></td>
                                                       $horarioSTD
                                                       $isOrden
         ...
         <div id="comentario_orden" title="Modificar comentario">
              <form id="upcmt">
	                <fieldset>
                              <div class="div">
		                      <label for="turno">Observacion</label>
                              </div>
