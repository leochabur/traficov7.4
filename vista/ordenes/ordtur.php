   ...
   /*  include('../../modelo/provincia.php');*/
     ...
     if (isset($_GET['otmo'])){
        ...
        $sql="SELECT o.id_cliente, id_ciudad_origen, lugar_salida, id_ciudad_destino,lugar_llegada,
                  ...
                  fservicio as fecha_orden, if (efc, 'checked','') as efc, ot.observaciones
...
<script type="text/javascript" src="<?php echo RAIZ;?>/vista/js/validate-form/jquery.metadata.js"></script>
 <script>
	$(function() {
        ...
        $('#n_interno, #pax').mask("9999");
        $('#viaticos').mask("9999.99");
        $('#preciofinal').mask("999999.99");
        $('#preciosiva').mask("999999.99");
        <?php
             $readonly="";
             $edit=false;
             $yarealizado=0;
             if (isset($_GET['otmo'])){
                ...
                print "$('#cliente option[value=$data[0]]').attr('selected', 'selected');
                       ...
                       $('#efc').prop( '$data[efc]', true );
                       $('#nomcontacto').val('$data[contacto]');
                       $('#telcontacto').val('$data[tel_contacto]');";
             }
             else{
                  $required="required";
             }
	           ...
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
                         ...
                         <table border="0" align="center" width="75%">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><input id="preciofinal" size="4" name="preciofinal" class="<?php echo $yarealizado?"":"";?> number ui-widget-content ui-corner-all"/><input name="efc" id="efc" type="checkbox" <?php echo ($edit&&$data[efc])?"checked":""; ?>></td>
                                </tr>
                                <tr>
