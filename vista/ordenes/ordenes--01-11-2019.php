              ...
              <table id='table' align="center" class="tablesorter" border="0" width="100%">
                     ...
                     <tbody>
                            <?php
                                 ...
                                 $resultDiag = mysql_query($sql, $con);  
				                 ...
				                 while($row = mysql_fetch_array($query)){
                                            ...
                                            if ($row[i_v] == 'i'){
                                               ...
                                               $horarioSTD="<td $tdclass align='center'></td>
                                                            ...
                                                            <td $tdclass align='center'><input type='text' name='hreal' size='5' value='$llega' id='hllegadaplantareal-$id' alt='Hora de llegada Real'></td>";
                                            }
                                            elseif ($row[i_v] == 'v'){
                                                   $hstd = $sale;
                                                   $horarioSTD="<td $tdclass align='center'><input type='text' name='hreal' size='5' value='$sale' id='hsalidaplantareal-$id' alt='Hora de salida Real'></td>
                                                                <td $tdclass><div align='center'>$hstd</div></td>
                                      ...
                                      /*    $cargapax = "";
                                           ...
                                           // if (($_SESSION['userid'] == 25) || ($_SESSION['userid'] == 18)|| ($_SESSION['userid'] == 37))
					                        ...
					                        $body.="<tr data-id='$id' style='height: 20px;' name='$name'>
                                                       <td $tdclass><div class='".($row[is_orden]?'horareal':'')."' id='hcitacionreal-$id'>$cita</div></td>
                                                       <td $tdclass><div>$sale</div></td>
                                                       <td $tdclass><div>".$row['nombre']."</div></td>
                                                       <td $tdclass><div><a href='/vista/segvial/posint.php?int=$row[interno]' target='_blank' onClick=\"window.open(this.href, this.target, 'width=900,height=650'); return false;\"><div style='color:#$row[color];'>$row[interno]</div></a></div></td>
                                                       <td $tdclass><div style='cursor: pointer;' onclick='mostrarDiag($row[id_empleado]);'>".($row['chofer1'])."</div></td>
                                                       <td $tdclass><div style='cursor: pointer;' onclick='mostrarDiag($row[id_empleado2]);'>".($row['chofer2'])."</div></td>";
                                         /* if ($cantTripulacion > 2){
                                               $body.="<td $tdclass><div class='$divclass' id='id_chofer_3-$id'>".($row['chofer3'])."</div></td>";
                                            }*/
                                            $isOrden="<td $tdclass></td>";
                                            if ($row['is_orden'] && !$row['cliVac']){
                                                $isOrden = "<td $tdclass><input type='text' name='hreal' size='2' value='$row[cantpax]' id='cantpax-$id' alt='Cant. Pax.'></td>";
                                            }
                                            $body.="<td $tdclass><div class='$divclass' id='razon_social-$id'>".($row['razon_social'])."</div></td>
                                                       <td $tdclass><div id='comentario-$id-updcmt'>$row[comentario]</div></td>
                                                       $horarioSTD
                                                       $isOrden
                                                       <td $tdclass><div id='hfinservicioreal-$id' class='".($row[is_orden]?'horareal':'')."'>$fina</div></td>
                                                   </tr>";
                                 }
                                 print $body;
