  ...
  $(function() {
        ...
        <?php
             if ($cantTripulacion > 2){
                print "$('#conductor2, #conductor3, #conductor4').selectmenu({width: 450});";
             }
        ?>
                                                                  ...
                                                                  $.post("cargar_combo_conductores.php", {fecha: date}, function(data){
                                                                                                                                    ...
                                                                                                                                    <?php
                                                                                                                                         if ($cantTripulacion > 2){
                                                                                                                                            ...
                                                                                                                                            $("#conductor4").empty();
                                                                                                                                            $("#conductor4").append(data);
                                                                                                                                            $("#conductor4").selectmenu({width: 450});';
                                                                                                                                         }
        ...
        $("#cliente").change(function(){
                                         ...
                                         $.post("/vista/paneles/comboDB.php",{cli: cliente, accion: 'lcr', ctr:$('#cantTr').val()},function(data){$("#serv-cli").html(data);
	           ...
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
                         ...
                         <table border="0" align="center" width="50%">
                               ...
                               print' <tr>
                                ...
                                <tr>
                                    <td WIDTH="20%">Conductor 4</td>
                                    <td><select id="conductor4" name="conductor4" class="ui-widget-content  ui-corner-all">
                                                <option value="0"></option>
