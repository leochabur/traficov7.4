 ...
 <script>
	...
	$(function(){
                 ...
                 $('#copy').click(function(){
                                             ...
                                             $.post('/modelo/ordenes/cpydiagramasur.php',
                     ...
                     <tbody>
                            ...
                            if (isset($_POST['cargar'])){
                                 ...
                                 if ($cantTripulacion > 2){
                                    $sql = "SELECT o.id, date_format(citacion, '%d/%m/%Y - %H:%i'), date_format(salida, '%d/%m/%Y - %H:%i'), upper(de.ciudad), upper(ha.ciudad), upper(cl.razon_social), upper(o.nombre)
                                            FROM (SELECT id, hcitacion, hsalida, nombre, id_servicio, id_estructura_servicio, id_ciudad_origen, id_estructura_ciudad_origen, id_ciudad_destino,
                                                         id_estructura_ciudad_destino, id_cliente, id_estructura_cliente, id_estructura
                                                  FROM ordenes
                                                  WHERE (fservicio = '$fecha') and (not borrada) and (id_estructura = $_SESSION[structure]) $vac) o
