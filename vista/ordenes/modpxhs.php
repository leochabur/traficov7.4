				                 ...
				                 while($row = mysql_fetch_array($result))
                         {
					                        ...
					                        $data.= "<tr id='trchk$row[id_orden]'>
                                             ...
                                             if ($row[id_cliente] == $cliente){
                                                       $data.= "<td class=\"$tdclass\"><input class='pax' type='text' size='5' value='$row[cantpax]' id='cantpax-$id'></td>";
                                             }
                                             else{
                                                  $data.= "<td class=\"$tdclass\"></td>";
                                             }
                                             $data.= "<td class=\"$tdclass\"><input class='obs' type='text' size='25' value='$row[comentario]' id='comentario-$id'></td>
