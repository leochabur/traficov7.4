				                 ...
				                 while($row = mysql_fetch_array($query)){
                                           ...
                                           // if (($_SESSION['userid'] == 25) || ($_SESSION['userid'] == 18)|| ($_SESSION['userid'] == 37))
					                        ...
					                        print "<tr class='headt'>
                                                       ...
                                                       <td class=\"$tdclass\"><div class=\"$divclass $turi\" id=\"nombre-$id\">".utf8_decode($row['nombre'])."</div></td>
                                                       ...
                                                       <td class=\"$tdclass\"><div class=\"$divclass\" id=\"id_chofer_1-$id\" style='cursor: pointer;' onclick='mostrarDiag($row[id_empleado]);'>".($row['chofer1'])."</div></td>
                                                       <td class=\"$tdclass\"><div class=\"$divclass\" id=\"id_chofer_2-$id\" style='cursor: pointer;' onclick='mostrarDiag($row[id_empleado2]);'>".($row['chofer2'])."</div></td>";
                                            if ($cantTripulacion > 2){
                                               print "<td class=\"$tdclass\"><div class=\"$divclass\" id=\"id_chofer_3-$id\">".htmlentities($row['chofer3'])."</div></td>";
                                            }
                                            print "<td class=\"$tdclass\"><div class=\"$divclass\" id=\"razon_social-$id\">".htmlentities($row['razon_social'])."</div></td>
                                                       <td class=\"$tdclass\"><div class=\"$obs $divclass\" id=\"comentario-$id-updcmt\">$row[comentario]</div></td>
                                                       <td class=\"$tdclass\" align='center'><input class='hora $salereal hreal' type='text' size='5' value='$row[hsalidaReal]' id='hsalidaplantareal-$id' alt='Hora de salida Real'></td>
                                                       <td class=\"$tdclass\"><div align='center'>$hstd</div></td>
                                                       <td class=\"$tdclass\" align='center'><input class='hora $llegareal hreal' type='text' size='5' value='$row[hllegadaReal]' id='hllegadaplantareal-$id' alt='Hora de llegada Real'></td>
                                                       <td class=\"$tdclass\"><input class='hreal $cargapax' type='text' size='2' value='$row[cantpax]' id='cantpax-$id' alt='Cant. Pax.'></td>
