...
<script type="text/javascript" src="<?php echo RAIZ;?>/vista/js/validate-form/jquery.metadata.js"></script>
 <script>
	$(function() {
        ...
        $('#origen, #destino, #cliente, #turnos, #tipos, #clase').selectmenu({width: 350});
        $('#interno, #iv').selectmenu({width: 100});
        $('#conductor').selectmenu({width: 450});
        ...
        $('#upuda').validate({
                                  submitHandler: function(){
                                                            ...
                                                            $.post("/modelo/segvial/altauda.php", $('#upuda').serialize(), function(data) {
                                                                                                                                                                     if(data == '0'){
                                                            ...
                                                            $.post("/modelo/procesa/procesar_ordenes.php", datos, function(data) {
                                                                                                                                  ...
                                                                                                                                  if (response.status){
                                                                                                                                      ...
                                                                                                                                      $('#commentForm :text').each (function(){
                                                                                                                                          ...
                                                                                                                                          alert('Se han producido errores '+response.sql);
                                                                                                                                  }
                                                                                                                                                    });
                                                           }
                                  });
...
?>
	           ...
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
                         ...
                         <table border="0" align="center" width="50%">
                                ...
                                <tr>
                                    ...
                                    <td><select id="tipos" name="tipos"  class="ui-widget-content  ui-corner-all"  validate="required:true">
                                                <?php
                                ...
                                <tr>
                                    <td WIDTH="20%">Turno Servicio</td>
                                    <td><select id="turnos" name="turnos"  class="ui-widget-content  ui-corner-all"  validate="required:true">
                                                <?php
                                ...
                                <tr>
                                    <td WIDTH="20%">Ida / Vuelta</td>
                                    <td><select id="iv" name="iv"  class="ui-widget-content  ui-corner-all"  validate="required:true">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><input id="hcitacion" size="<?php print ($cantTripulacion>2)?15:4; ?>" name="hcitacion" class="required hora ui-widget-content ui-corner-all" /></td>
                                </tr>
                                <tr>
                                    <td WIDTH="20%">Hora Salida</td>
                                    <td colspan="2"><input id="hsalida" size="<?php print ($cantTripulacion>2)?15:4; ?>" name="hsalida" class="required hora ui-widget-content ui-corner-all" /></td>
                                </tr>
                                <tr>
                                    <td WIDTH="20%">Hora Llegada</td>
                                    <td colspan="2"><input id="hllegada" size="<?php print ($cantTripulacion>2)?15:4; ?>" name="hllegada" class="required hora ui-widget-content ui-corner-all" /></td>
                                </tr>
                                <tr>
                                    <td WIDTH="20%">Hora Fin Servicio</td>
                                    <td colspan="2"><input id="hfins" size="<?php print ($cantTripulacion>2)?15:4; ?>" name="hfins" class="required hora ui-widget-content ui-corner-all" /></td>
                                </tr>
                                <tr>
  ...
  <input type="hidden" name="cantTr" value="<?php print $cantTripulacion; ?>">
</form>
	</div>
