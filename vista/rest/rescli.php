...
<script type="text/javascript">
                          $(document).ready(function(){
                                                       $("#load").button().click(function(){
                                                                                              ...
                                                                                              $.post("/modelo/rest/rescli.php", {accion:'loadres', cli:$('#clientes').val(), str:$('#str').val()}, function(data){$('#files').html(data);});
                                                       });
    ...
    <br><br>
         <form id="upuda">
	           <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Restricciones de Clientes</legend>
		                 <div id="mensaje"> </div>
		                 <fieldset class="ui-widget ui-widget-content ui-corner-all">
		                 <legend class="ui-widget ui-widget-header ui-corner-all">Cargar Restriccion</legend>
                         <table border="0" align="center" width="40%" name="tabla">
                                <tr>
                                    <td>Estructura</td>
                                    <td align="right">
                                  ...
                                  <tr>
                                    <td>Cliente</td>
                                    <td id="clis" align="right">
                                    </td>
                                </tr>
                                <tr>
                                  <td colspan="2" align="right"><input type="button" id="load" value="Cargar Restricciones"></td>
                                </tr>
                         </table>
<div id="files">
</div>
