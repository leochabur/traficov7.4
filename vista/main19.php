           ...
           $menu.='<li><a href="#" class="parent"><span>Simulacion Vacios</span></a>
                                                 <div>
                                                      <ul>
                                                          ...
                                                          <li><a href="'.RAIZ.'/vista/ordenes/smlvacv3.php"><span>Simular Vacios V 3.0</span></a></li>                                                         
                                                      </ul>
                                                 </div>
                                          </li>';
        }
                                                  ...
                                                  <li>
                                                     ...
                                                     <div>
                                                          <ul>
                                                              ...
                                                              <li><a href="'.RAIZ.'/vista/servicios/newtrf.php"><span>Nueva Factura Venta</span></a></li>
